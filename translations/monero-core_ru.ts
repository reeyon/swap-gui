...
<context>
    ...
    <message>
        ...
        <translation>Это облегчает отправку и получение swap и снижает количество ошибок при вводе адресов вручную.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>ПРЕДУПРЕЖДЕНИЕ: Не используйте повторно свои ключи swap на другом форке, ЕСЛИ ТОЛЬКО этот форк не имеет встроенные средства защиты от компрометации введенных ключей. Подобные действия могут повредить вашей конфиденциальности.</translation>
    </message>
    <message>
        ...
        <translation>ВНИМАНИЕ: Копирование вашей мнемонической фразы в буфер обмена может сопровождаться перехватом этих данных различным вредоносным программным обеспечением, которое отправит вашу мнемонику злоумышленнику, после чего ваши swap могут быть украдены. Пожалуйста, вводите вашу мнемоническую фразу вручную с клавиатуры.</translation>
    </message>
    <message>
...
Mining also gives you a small chance to earn some swap. Your computer will create hashes looking for block solutions. If you find a block, you will get the associated reward. Good luck!</source>
        <translation>Майнинг на вашем компьютере помогает укрепить сеть swap. Чем больше людей майнят, тем сложнее атаковать сеть, каждый может помочь.

Майнинг также даёт маленький шанс получить swap. Ваш компьютер будет создать хеши в поиске решения блока. Если вы найдёте блок, то получите награду. Удачи!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Встроенная версия swap: </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Использовать сторонний узел для подключения к сети swap. Менее безопасно, но более быстро и удобно.</translation>
    </message>
    <message>
        ...
        <translation>Чтобы получить список удаленных нод, введите &apos;swap remote node&apos; в вашем любимом поисковике. Пожалуйста, убедитесь, что выбранной ноде можно доверять.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>На этой странице можно взаимодействовать с общей базой данных RingDB. Эта база данных предназначается для использования кошельками swap или их клонов, которые смогут повторно использовать ключи swap.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Для того чтобы скрыть какие входы в транзакциях swap потрачены, третья сторона не должна сообщать какие входы в кольце уже задействованы в трате. Ведь если это сделать, то это ослабит защиту, обеспечиваемую кольцевыми подписями. Если известно, что все, кроме одного из входов, уже потрачены, то фактически трата входа становится очевидной, тем самым аннулируется эффект кольцевых подписей, одного из трех основных уровней защиты конфиденциальности swap.&lt;br&gt;Чтобы помочь транзакциям избежать траты этих входов, можно использовать список известных израсходованных выходов, чтобы избежать их использования в новых транзакциях. Такой список поддерживается проектом swap и доступен на веб-сайте getswap.org, и вы можете импортировать этот список здесь.&lt;br&gt;Кроме того, вы можете просканировать блокчейн swap (и его клонов) самостоятельно, используя инструмент swap-blockchain-mark-spent-outputs, чтобы создать список известных потраченых выходов.&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Чтобы избежать аннулирования защиты, предоставляемой кольцевыми подписями swap, выход не должен быть потраченным с другими значениями размера кольца и на других блокчейнах. Хотя, как правило, это не является проблемой, в некоторых случаях повторное использование ключей swap позволяет потратить существующие выходы. В таких случаях вам необходимо позаботиться, чтобы эти существующие выходы использовали одно и то же кольцо в обеих блокчейнах.&lt;br&gt;Это может быть сделано автоматически с помощью любого программного обеспечения для повторного использования ключей от swap-клонов, и даже если эти клоны не предоставляют подобную защиту, вы все еще можете проверить, что ваши транзакции защищены, путем ручного введения размера кольца на этой странице, которая позволит вам потратить ваши swap безопасно.&lt;br&gt;Если вы не используете программное обеспечения от swap-клонов, вам ничего не нужно делать, так как все будет сделано автоматически.&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>Здесь записываются кольца, используемые выходами, проводимыми на swap, в цепочке повторного использования ключей, так что одно и то же кольцо можно использовать повторно, чтобы избежать проблем с конфиденциальностью.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введите адрес swap (например: 44AFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Чтобы иметь возможность обмениваться данными с сетью swap, ваш кошелек должен быть подключен к ноде swap. Для лучшей конфиденциальности рекомендуется запустить свою собственную ноду.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Кроме того, вы можете указать ноду быстрой загрузки, чтобы немедленно начать пользоваться swap.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Добро пожаловать в swap.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Выберете эту опцию, если вы впервые пользуетесь swap.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Создать новый кошелек, подключившись к вашему аппаратному кошельку swap.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Изменить язык графического интерфейса swap.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Временное использование удаленных нод полезно для немедленного использования swap (отсюда название &quot;начальной загрузки&quot;), однако помните, что при использовании удаленных узлов (включая настройку ноды начальной загрузки), узлы могут отслеживать ваш IP адрес, отслеживать вашу &quot;высоту восстановления&quot; и соответствующие данные запроса блока, и отправлять вам неточную информацию, чтобы узнать больше о совершаемых вами транзакциях.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Этот режим идеально подходит для управления небольшими суммами swap. У вас есть доступ к основным функциям для совершения транзакций и управления ими. Программа автоматически подключится к сети swap, чтобы вы сразу могли начать использовать swap.</translation>
    </message>
    <message>
...
If you don&apos;t have the option to run your own node, there&apos;s an option to connect to a remote node.</source>
        <translation>Чтобы иметь возможность обмениваться данными с сетью swap, ваш кошелек должен быть подключен к ноде swap. Для лучшей конфиденциальности рекомендуется запустить свою собственную ноду.
...
может требоваться ваше подтверждение.</translation>
    ...
    <message>
        ...
        <translation>swap успешно отправлены: %1 транзакция(й) </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Новая версия swap v.%1 доступна.&lt;br&gt;&lt;br&gt;Скачать:&lt;br&gt;%2&lt;br&gt;&lt;br&gt;SHA256 хэш:&lt;br&gt;%3</translation>
    </message>
    <message>
        <location filename="../main.qml" line="2172"/>
        <source>New version of swap is available. Check out getswap.org</source>
        <translation>Новая версия swap доступна. Проверьте getswap.org</translation>
    </message>
    <message>
